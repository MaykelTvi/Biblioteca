...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2024 a las 20:42:04
...
INSERT INTO `libros` (`id_libro`, `titulo`, `autor`, `estado`) VALUES
(1, 'El principito', 'Antoine de Saint-Exupéry', 'Disponible'),
(2, 'La voz ausente', 'Gabriel Rolon', 'Prestado'),
(3, 'Harry Potter y la piedra filosofal', 'J.K Rowling', 'Disponible'),
(4, 'Harry Potter y el Caliz de fuego', 'J.K Rowling', 'Prestado');
