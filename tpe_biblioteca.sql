...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2024 a las 20:41:28
...
CREATE TABLE `libros` (
  ...
  `prestado` tinyint(4) NOT NULL DEFAULT 0
...
INSERT INTO `libros` (`id_libro`, `titulo`, `autor`, `prestado`) VALUES
(1, 'Harry Potter y la Piedra Filosofal', 'J.K Rowling', 0),
...
(1, 'bautimenna6@gmail.com', '$2y$10$9boEIiTw.s37isRw8csXP.gNdh9ZahfoQRPn/qJMwsxqrCSZzINy2', 1),
