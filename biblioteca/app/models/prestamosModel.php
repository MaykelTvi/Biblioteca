...
class prestamosModel {
    ...
    function insertarPrestamo($idUsuario, $titulo, $fecha) {
        $query = $this->db->prepare('INSERT INTO prestamos(id_usuario, titulo_libro, fecha_prestamo) VALUES(?,?,?)');
        $query->execute (array($idUsuario, $titulo, $fecha));
